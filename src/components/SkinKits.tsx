...
const SkinKits = () => {
  ...
  return (
    <section id="kits" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-20 left-0 w-72 h-72 bg-gradient-to-br from-turquoise/10 to-lime/10 rounded-full -translate-x-36"></div>
      <div className="absolute bottom-20 right-0 w-64 h-64 bg-gradient-to-br from-coral/10 to-rose/10 rounded-full translate-x-32"></div>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-6 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Apresentando os{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-turquoise to-coral">
                Kits Lanoa
              </span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {kits.map((kit, index) => (
              ...
              >
                {/* Gradient Background */}
                <div className={`absolute inset-0 bg-gradient-to-br ${kit.color} opacity-10 group-hover:opacity-20 transition-opacity duration-300`}></div>
                    ...
                    <ul className="space-y-2">
                      {kit.benefits.map((benefit, i) => (
                        <li key={i} className="text-sm text-gray-600 flex items-start gap-2">
                          <div className="w-1.5 h-1.5 bg-gradient-to-r from-turquoise to-coral rounded-full mt-2 flex-shrink-0"></div>
                          {benefit}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="text-center animate-fade-in">
            <Button 
              ...
              size="lg"
              className="bg-gradient-to-r from-coral to-orange-500 hover:from-coral-dark hover:to-orange-600 text-white font-bold py-4 px-12 rounded-full text-lg shadow-xl transform hover:scale-105 transition-all duration-300"
            >
