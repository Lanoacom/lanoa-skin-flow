...
const Benefits = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-turquoise/5 to-lime/5 rounded-full -translate-y-48"></div>
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-br from-coral/5 to-rose/5 rounded-full translate-y-40"></div>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-6 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-turquoise via-coral to-lime">
                Diferentes
              </span>
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-fade-in"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16 border-t border-gray-200 animate-fade-in">
            <div className="text-center">
              <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-turquoise to-coral mb-2">
                20K+
              </div>
              <p className="text-sm text-gray-600">Clientes Satisfeitas</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-lime to-sky mb-2">
                97%
              </div>
              <p className="text-sm text-gray-600">Resultados em 21 Dias</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-coral to-rose mb-2">
                4.9★
              </div>
              <p className="text-sm text-gray-600">Avaliação Média</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky to-turquoise mb-2">
                30 Dias
              </div>
